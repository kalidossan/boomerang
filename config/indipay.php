...
return [
    ...
    */
    ...
    'payumoney' => [                         // PayUMoney Parameters
        'merchantKey'  => env('INDIPAY_MERCHANT_KEY', 'lH72jsZF'),
        'salt'  => env('INDIPAY_SALT', 'sEt0JLCTJf'),
        'workingKey' => env('INDIPAY_WORKING_KEY', ''),

        // Should be route address for url() function
        'successUrl' => env('INDIPAY_SUCCESS_URL', 'payment-success'),
        'failureUrl' => env('INDIPAY_FAILURE_URL', 'payment-failure'),
