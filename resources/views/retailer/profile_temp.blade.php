                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control profile_registration" id="profile_biz_name" name="profile_biz_name" value="{{ $retailer->RET_BIZ_NAME }}"/>
                                    </div>

                                    <div class="form-group">
                                        <div class="title">First Name</div>
                                        <input type="text" autocomplete="off" class="form-control profile_registration" id="profile_first_name" name="profile_first_name" value="{{ $retailer->RET_FIRST_NAME }}"/>
                                    </div>
                                    <div class="form-group">
                                        <div class="title">Last Name</div>
                                        <input type="text" autocomplete="off" class="form-control profile_registration" id= "profile_last_name" name="profile_last_name" value="{{ $retailer->RET_LAST_NAME }}"/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input autocomplete="off" name="dos" type="text" value="{{ $retailer->RET_BIZ_START_DT }}" class="form-control pull-right " id="dos" autocomplete="off">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="mobile" autocomplete="off" class="form-control retailer_registration" id="gst_no" name="gst_no" value="{{ $retailer->RET_GST_NUMBER }}"/>
                                    </div>
