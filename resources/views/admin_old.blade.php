            ...
            <div class="col-sm-3 panel">
                ...
                <div id="admin_menu">
                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="top-bar-title padding-bottom"><i class="fa fa-pencil-square-o"></i>Admin Controls</div>
                            </div> 
                        </div>            
                    </div> 
              <div class="menu">
                <ul>
                    <li class="admin_menu"> <a href="#">Registration</a></li>
                    <li class="admin_menu"> <a href="#">Payment</a></li>
                    <li class="admin_menu"> <a href="#">Message Moderator</a></li>
                    <li class="admin_menu"> <a href="#">Plan Entry</a></li>
                    <li class="admin_menu"> <a href="#">Customers Verification </a></li>
                </ul>
            </div>
            </div>
            </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                ...
                <div class="bhoechie-tab-content">
                    <center>
                      ...
                      <h2 style="margin-top: 0;color:#55518a">Cooming Soon</h2>
                      <h3 style="margin-top: 0;color:#55518a">Hotel Directory</h3>sdas
                    </center>
                </div>
                <div class="bhoechie-tab-content">
                    <center>
